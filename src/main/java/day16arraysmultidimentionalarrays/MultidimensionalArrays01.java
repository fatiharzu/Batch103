...
//      Multidimensional Array nasil olsuturulur?

        int arr[][] = new int[3][2];

        // Multidimensional Array'lere eleman ekleme nasil yapiliz
        ...
        //Multidimensional Array'lerde Array elamnlardan biri nasil yazdirilir.
