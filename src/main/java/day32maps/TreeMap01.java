...
/**
 *          1)TreeMap'ler entrySet'leri key'lere gore "natural order" da siralar.<br>
 *         2)TreeMap'ler en yavas map'lerdir.<br>
 *         3)TreeMap'ler thread-safe ve syncronized degildir.<br>
 */
